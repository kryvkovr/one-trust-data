...
export default class OTPublishersNativeSDK{
  ...
  */
  ...
  /**
   * @returns Promise json with preference center Data
   */
   static getPreferenceCenterData():Promise<string>{
    return OneTrust.getPreferenceCenterData();
  }

   /**
   * @returns Promise json with banner Data
   */
    static getBannerData():Promise<string>{
      return OneTrust.getBannerData();
    }
